...
const WalletModal: React.FC<Props> = (props) => {
  return (
    ...
    >
      <div className="relative z-20 max-w-lg w-full lg:w-1/4 md:w-1/2 shadow flex flex-col mt-20 rounded-2xl items-center mx-4 bg-gray-900 lg:mt-[10%] lg:mx-0 min-h-30">
